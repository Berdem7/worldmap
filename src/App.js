// import logo from "public/images/world.svg";
import "./App.css";
...
function App() {
  ...
  // const ccs = data.map((item, index) => {
  //   <path
  //     className={Object.values(data)[index]}
  ...
  //     fill={fill.includes("Argentina") ? "green" : ""}
  //   ></path>;
  // });
  // console.log(ccs);
  ...
  //   data["name"] = data[key]; //saving reference in your new key.
  //   delete data[key]; //deleting old key;
  // });
  ...
  const handleSubmit = (e) => {
    ...
    let inputValue = capital(e.target[0].value);
    if (countries.includes(inputValue)) {
      console.log("True");
      setFill([...fill, inputValue]);
      e.target.reset();
    }
  };
    ...
    <div className="App">
      ...
      >
        <path
          ...
          id="AF"
          name="Afghanistan"
          fill={fill.includes("Afghanistan") ? "green" : ""}
        ></path>
        <path
          className="Angola"
          ...
          fill={fill.includes("Angola") ? "green" : ""}
        ></path>
        <path
          className="Angola"
        ...
        <path
          ...
          id="AL"
          name="Albania"
          fill={fill.includes("Albania") ? "green" : ""}
        ></path>
        <path
          ...
          fill={fill.includes("UAE" || "United Arab Emirates") ? "green" : ""}
        ></path>
        <path
          className="Argentina"
        ...
        <path
          ...
          id="AM"
          name="Armenia"
          fill={fill.includes("Armenia") ? "green" : ""}
        ></path>
        <path
          className="Australia"
          ...
          fill={fill.includes("Australia") ? "green" : ""}
        ></path>
        <path
          className="Australia"
        ...
        <path
          ...
          id="AT"
          name="Austria"
          fill={fill.includes("Austria") ? "green" : ""}
        ></path>
        <path
          ...
          fill={fill.includes("Azerbaijan") ? "green" : ""}
        ></path>
        <path
          className="Azerbaijan"
        ...
        <path
          ...
          id="BI"
          name="Burundi"
          fill={fill.includes("Burundi") ? "green" : ""}
        ></path>
        <path
          ...
          id="BE"
          name="Belgium"
          fill={fill.includes("Belgium") ? "green" : ""}
        ></path>
        <path
          ...
          id="BJ"
          name="Benin"
          fill={fill.includes("Benin") ? "green" : ""}
        ></path>
        <path
          ...
          id="BF"
          name="Burkina Faso"
          fill={fill.includes("Burkina Faso") ? "green" : ""}
        ></path>
        <path
          ...
          id="BD"
          name="Bangladesh"
          fill={fill.includes("Bangladesh") ? "green" : ""}
        ></path>
        <path
          ...
          id="BG"
          name="Bulgaria"
          fill={fill.includes("Bulgaria") ? "green" : ""}
        ></path>
        <path
          ...
          fill={
            fill.includes("Bosnia" || "Bosnia and Herzegovina") ? "green" : ""
          }
        ></path>
        <path
          ...
          id="BY"
          name="Belarus"
          fill={fill.includes("Belarus") ? "green" : ""}
        ></path>
        <path
          ...
          id="BZ"
          name="Belize"
          fill={fill.includes("Belize") ? "green" : ""}
        ></path>
        <path
          ...
          id="BO"
          name="Bolivia"
          fill={fill.includes("Bolivia") ? "green" : ""}
        ></path>
        <path
        ...
        <path
          ...
          id="BW"
          name="Botswana"
          fill={fill.includes("Botswana") ? "green" : ""}
        ></path>
        <path
          ...
          fill={fill.includes("Central African Republic") ? "green" : ""}
        ></path>
        <path
          className="Canada"
          fill={fill.includes("Canada") ? "green" : ""}
        ...
        <path
          ...
          id="CH"
          name="Switzerland"
          fill={fill.includes("Swizerland") ? "green" : ""}
        ></path>
        <path
          className="China"
          fill={fill.includes("China") ? "green" : ""}
        ...
        <path
          ...
          id="CI"
          name="Côte d'Ivoire"
          fill={fill.includes("Ivory Coast") ? "green" : ""}
        ></path>
        <path
          ...
          id="CM"
          name="Cameroon"
          fill={fill.includes("Cameroon") ? "green" : ""}
        ></path>
        <path
        ...
        <path
          ...
          id="CO"
          name="Colombia"
          fill={fill.includes("Colombia") ? "green" : ""}
        ></path>
        <path
        ...
        <path
          ...
          id="CZ"
          name="Czech Republic"
          fill={fill.includes("Czechia" || "Czech Republic") ? "green" : ""}
        ></path>
        <path
          ...
          id="DE"
          name="Germany"
          fill={fill.includes("Germany") ? "green" : ""}
        ></path>
        <path
